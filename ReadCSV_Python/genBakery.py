            ...
            for row in csvreader:
                ...
                try:
                    ...
                    sql_insert_statement = (
                        f"INSERT INTO {table_name} (ReceiptNumber, Date, CustomerID) "
                        f"VALUES ({ReceiptNumber}, {Date}, {CustomerID});\n"
                    )
...
if __name__ == "__main__":
    ...
    sql_file = 'BAKERY-build-Receipts.sql'    # Output SQL file
    table_name = 'Receipts'               # Your actual table name
