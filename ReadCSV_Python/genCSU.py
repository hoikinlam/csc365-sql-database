            ...
            for row in csvreader:
                ...
                try:
                    ...
                    sql_insert_statement = (
                        f"INSERT INTO {table_name} (CampusID, Year, Faculty) "
                        f"VALUES ({CampusID}, {Year}, {Faculty});\n"
                    )
...
if __name__ == "__main__":
    ...
    sql_file = 'CSU-build-Faculty.sql'    # Output SQL file
    table_name = 'Faculty'               # Your actual table name
