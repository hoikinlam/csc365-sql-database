            ...
            for row in csvreader:
                ...
                try:
                    ...
                    sql_insert_statement = (
                        f"INSERT INTO {table_name} (Place, Time, Pace, GroupPlace, ParticipantGroup, Age, Sex, BIBNumber, FirstName, LastName, Town, State) "
                        f"VALUES ({Place}, {Time}, {Pace}, {GroupPlace}, {ParticipantGroup}, {Age}, {Sex}, {BIBNumber}, {FirstName}, {LastName}, {Town}, {State});\n"
                    )
...
if __name__ == "__main__":
    ...
    sql_file = 'Marathon-build-Marathon.sql'    # Output SQL file
    table_name = 'Marathon'               # Your actual table name
