            ...
            for row in csvreader:
                ...
                try:
                    ...
                    sql_insert_statement = (
                        f"INSERT INTO {table_name} (SongID, MemberID, Type) "
                        f"VALUES ({SongID}, {MemberID}, {Type});\n"
                    )
...
if __name__ == "__main__":
    ...
    sql_file = 'KATZENJAMMER-build-Vocals.sql'    # Output SQL file
    table_name = 'Vocals'               # Your actual table name
