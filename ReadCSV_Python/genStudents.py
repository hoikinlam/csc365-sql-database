            ...
            for row in csvreader:
                ...
                try:
                    ...
                    sql_insert_statement = (
                        f"INSERT INTO {table_name} (LastName, FirstName, Classroom) "
                        f"VALUES ({LastName}, {FirstName}, {Classroom});\n"
                    )
...
if __name__ == "__main__":
    ...
    sql_file = 'STUDENTS-build-Teachers.sql'    # Output SQL file
    table_name = 'Teachers'               # Your actual table name
